...
data class UserProfile(
    ...
    val savedEducationJson: String = "[]",
    val savedCertificationsJson: String = "[]",
    val savedAchievementsJson: String = "[]",
...
class UserProfileStore(private val context: Context) {
    companion object {
        ...
        val SAVED_EDUCATION = stringPreferencesKey("saved_education")
        val SAVED_CERTIFICATIONS = stringPreferencesKey("saved_certifications")
        val SAVED_ACHIEVEMENTS = stringPreferencesKey("saved_achievements")
    ...
    val userProfileFlow: Flow<UserProfile> = context.userProfileDataStore.data.map { p ->
        UserProfile(
            ...
            savedSkillsJson = p[SAVED_SKILLS] ?: "[]", 
            savedEducationJson = p[SAVED_EDUCATION] ?: "[]",
            savedCertificationsJson = p[SAVED_CERTIFICATIONS] ?: "[]",
            savedAchievementsJson = p[SAVED_ACHIEVEMENTS] ?: "[]",
            chatHistoryJson = p[CHAT_HISTORY] ?: "[]"
        )
    }
    ...
    suspend fun saveUserProfile(profile: UserProfile) {
        context.userProfileDataStore.edit { p ->
            ...
            p[SAVED_SKILLS] = profile.savedSkillsJson; 
            p[SAVED_EDUCATION] = profile.savedEducationJson;
            p[SAVED_CERTIFICATIONS] = profile.savedCertificationsJson;
            p[SAVED_ACHIEVEMENTS] = profile.savedAchievementsJson;
            p[CHAT_HISTORY] = profile.chatHistoryJson
        }
    }
}